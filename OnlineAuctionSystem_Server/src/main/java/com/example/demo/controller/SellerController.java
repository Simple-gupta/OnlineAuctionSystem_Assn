...
public class SellerController {
	...
	public ResponseEntity<Seller> updateProduct(@PathVariable Integer id,@RequestBody Seller sellerProduct){
		Seller seller = sellerRepository.findById(id)
				.orElseThrow(()-> new ResourceNotFoundException("Seller not exists "+id));
	...
	public ResponseEntity<Seller> deleteProduct(@PathVariable Integer id,@RequestBody Seller sellerProduct){
		Seller seller = sellerRepository.findById(id)
				.orElseThrow(()-> new ResourceNotFoundException("Seller not exists "+id));
	...
	public ResponseEntity<Map<String,Boolean>> deleteSeller(@PathVariable Integer id){
		Seller seller = sellerRepository.findById(id)
				.orElseThrow(()-> new ResourceNotFoundException("Seller not exists "+id));
